...
public class AgentMovement : MonoBehaviour
{
    ...
    public void Initialize(Agent entity)
    {
        ...
        _renderer = entity.GetCompo<AgentRenderer>();
        _stat = entity.GetCompo<AgentStat>();
    ...
    private void FixedUpdate()
    {
        ...
        _rbCompo.velocity = new Vector2(_rbCompo.velocity.x
            ,Mathf.Clamp(_rbCompo.velocity.y, -LimitYSpeed, LimitYSpeed));
    }

    public void CheckGround()
    {
        Physics2D.SyncTransforms(); // 트랜스폼 모양과 물리모양 일치
